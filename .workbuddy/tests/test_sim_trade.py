...
class TestCalcCommission:
    def test_normal_commission(self):
        from sim_trade import COMMISSION_RATE, calc_commission
    ...
    def test_minimum_commission(self):
        from sim_trade import MIN_COMMISSION, calc_commission
...
class TestCalcStampTax:
    def test_sell_tax(self):
        from sim_trade import STAMP_TAX_RATE, calc_stamp_tax
